...
from ...states.density_matrices import DensityMatrix
...
def negativity(
    ...
    rho = DensityMatrix.convert_to_density_matrix(rho)
...
def log_negativity(val: DensityMatrix|float) -> float:
